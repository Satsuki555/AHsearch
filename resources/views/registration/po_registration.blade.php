...
<head>
    ...
    <title>AHsearchペットオーナー新規会員登録</title>
</head>
<body>
    ...
    <h1>ペットオーナー様<br>新規登録</h1>

    <form action="{{ route('po_confirm') }}" method="post">
        @csrf
        ...
        @endif
        <input type="text" name="name" id="name" placeholder="氏名" value="{{ old('name') }}">
        ...
        <input type="hidden" name="role" id="po_role" value="0">
